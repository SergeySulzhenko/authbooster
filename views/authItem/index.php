...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns' => array(
		...
		array(
			...
			'viewButtonUrl' => "Yii::app()->controller->createUrl('view', array('name'=>rawurlencode(\$data->name)))",
			'updateButtonLabel' => Yii::t('AuthModule.main', 'Edit'),
			'updateButtonUrl' => "Yii::app()->controller->createUrl('update', array('name'=>rawurlencode(\$data->name)))",
			'deleteButtonLabel' => Yii::t('AuthModule.main', 'Delete'),
			'deleteButtonUrl' => "Yii::app()->controller->createUrl('delete', array('name'=>rawurlencode(\$data->name)))",
